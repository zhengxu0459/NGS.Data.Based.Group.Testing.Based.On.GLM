# 
# R script file to implement the variable collapse test for continous phenotype
# version: 1.2 (continuously updated)
# author: Zheng Xu

variable.collapse.test.continous.phenotype=function(pheno,snp.glf,
  ...
  # score statistic and p value for the variable collapse test for continuous phenotype
  Collapsed.Score = t(Collapsed.Score.vector)%*%solve(Collapsed.Hessian.matrix)%*%Collapsed.Score.vector 
