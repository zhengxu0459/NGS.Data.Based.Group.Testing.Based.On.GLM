# 
# R Script file to implement our joint significance test for binary phenotype
# Version 1.2 (continuously updated)
# Author: Zheng Xu

joint.significance.test.binary.phenotype = function(pheno,snp.glf,
  ...
  #### for binary phenotype
    ...
    Hessian.Alpha.T.Alpha = 
		matrix(0,sub.n.covariate,sub.n.covariate)
	...
	# Score statistic and p value for joint significance test for binary phenotype
